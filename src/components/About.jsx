...
const About = () => {
  return (
    <div
      name="about"
      className="w-full h-screen bg-[#00bf62] text-white"
    >
      <div className="max-w-screen-lg p-4 mx-auto justify-center w-full md:w-auto">
        <div className="pb-8">
          <p className="text-4xl font-bold inline border-b-4 border-text-white">
            About
          </p>
        </div>
